                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or save_crop or view_img:  # Add bbox to image
                        ...
                        if names[int(cls)] == 'apple':
                            ...
                            print(txt_x, txt_y)
                            if 320 - 5 < txt_x < 320 + 5 :
                                txt_x = 320
                            if 240 - 5 < txt_y < 240 + 5:
                                txt_y = 240
                            message = {}
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default= 'http://192.168.1.102:8080/?action=stream', help='file/dir/URL/glob/screen/0(webcam)')
